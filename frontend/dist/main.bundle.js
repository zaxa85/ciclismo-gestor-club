    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["K" /* NgModule */])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_11__services_index__["l" /* UserService */],
                ...
                __WEBPACK_IMPORTED_MODULE_11__services_index__["j" /* SportEventService */],
                __WEBPACK_IMPORTED_MODULE_8__angular_cdk_layout__["d" /* MediaMatcher */],
                __WEBPACK_IMPORTED_MODULE_11__services_index__["k" /* StorageService */],
...
var appRoutes = [
    ...
    { path: 'sport.event', component: __WEBPACK_IMPORTED_MODULE_6__sport_index__["a" /* SportEventComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_7__guards_index__["a" /* AuthGuard */]] },
    {
        path: 'sport.event/:id',
        canActivate: [__WEBPACK_IMPORTED_MODULE_7__guards_index__["a" /* AuthGuard */]],
        component: __WEBPACK_IMPORTED_MODULE_6__sport_index__["a" /* SportEventComponent */]
    },
...
var RegisterPaymentComponent = (function () {
    ...
    RegisterPaymentComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */],
            ...
            __WEBPACK_IMPORTED_MODULE_2__services_index__["k" /* StorageService */],
...
var HomeComponent = (function () {
    ...
    HomeComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_index__["l" /* UserService */]])
    ], HomeComponent);
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "f", function() { return __WEBPACK_IMPORTED_MODULE_9__sportevent__["a"]; });
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SportEvent; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "l", function() { return __WEBPACK_IMPORTED_MODULE_5__user_service__["a"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "j", function() { return __WEBPACK_IMPORTED_MODULE_11__sportevent_service__["a"]; });
...
var PeriodService = (function () {
    ...
    PeriodService.prototype.getByStatus = function (status) {
        return this.http.get(this.API_URL + '/api/period', {
            search: { filter: JSON.stringify({ "where": { status: status }, "order": "id DESC" }) }
        }).map(function (response) { return response.json(); });
    };
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SportEventService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_http__ = __webpack_require__("../../../http/esm5/http.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__environments_environment__ = __webpack_require__("../../../../../src/environments/environment.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
...
var SportEventService = (function () {
    ...
    SportEventService.prototype.getByStatus = function (status) {
        return this.http.get(this.API_URL + '/api/sportevent', {
            search: { filter: JSON.stringify({ "where": { status: status } }) }
        }).map(function (response) { return response.json(); });
    };
    SportEventService.prototype.getByStatusAndPeriod = function (period, status) {
        return this.http.get(this.API_URL + '/api/sportevent', {
            search: { filter: JSON.stringify({ "where": { status: status, id_fk_period_id: period }, "order": "datestart ASC" }) }
        }).map(function (response) { return response.json(); });
    };
...
module.exports = "<div class=\"col-md-6 col-md-offset-3\">\r\n\t<h4>\r\n\t\tRegistro de Evento\r\n\t</h4>\r\n\r\n\t<form data-toggle=\"validator\" role=\"form\" name=\"form\" (ngSubmit)=\"f.form.valid && register()\" #f=\"ngForm\"\r\n\t\tnovalidate>\r\n\r\n\t\t<div class=\"form-group\" [ngClass]=\"{ 'has-error': f.submitted }\">\r\n\t\t\t<input type=\"hidden\" class=\"form-control\" name=\"id\" [(ngModel)]=\"sportEvent.id\" #id=\"ngModel\"\r\n\t\t\t\tvalue=\"{{sportEvent.id}}\" />\r\n\t\t</div>\r\n\t\t<div class=\"form-group\" [ngClass]=\"{ 'has-error': f.submitted  && !status.valid}\">\r\n\t\t\t<label for=\"status\">Estado</label> <select class=\"form-control\" [(ngModel)]=\"sportEvent.status\" name=status\r\n\t\t\t\t#status=\"ngModel\">\r\n\t\t\t\t<option *ngFor=\"let c of statuses\" [ngValue]=\"c.id\">{{c.name}}</option>\r\n\t\t\t</select>\r\n\t\t</div>\r\n\r\n\t\t<div class=\"form-group\" [ngClass]=\"{ 'has-error': f.submitted && !name.valid }\">\r\n\t\t\t<label for=\"name\">Nombre Comercial</label> <input type=\"text\" class=\"form-control\" name=\"name\"\r\n\t\t\t\t[(ngModel)]=\"sportEvent.name\" #name=\"ngModel\" required value=\"{{sportEvent.name}}\" />\r\n\t\t\t<div *ngIf=\"f.name && !name.valid\" class=\"help-block\">Nombre comercial es requerido</div>\r\n\t\t</div>\r\n\r\n\t\t<div class=\"form-group\" [ngClass]=\"{ 'has-error': f.submitted && !organizer.valid }\">\r\n\t\t\t<label for=\"organizer\">Organizador</label> <input type=\"text\" class=\"form-control\" name=\"organizer\"\r\n\t\t\t\t[(ngModel)]=\"sportEvent.organizer\" #organizer=\"ngModel\" required value=\"{{sportEvent.organizer}}\" />\r\n\t\t\t<div *ngIf=\"f.organizer && !organizer.valid\" class=\"help-block\">Nombre comercial es requerido</div>\r\n\t\t</div>\r\n\r\n\t\t<div class=\"form-group\" [ngClass]=\"{ 'has-error': f.submitted && !location.valid }\">\r\n\t\t\t<label for=\"location\">Ubicación</label> <input type=\"text\" class=\"form-control\" name=\"location\"\r\n\t\t\t\t[(ngModel)]=\"sportEvent.location\" #location=\"ngModel\" required value=\"{{sportEvent.location}}\" />\r\n\t\t\t<div *ngIf=\"f.location && !location.valid\" class=\"help-block\">Nombre comercial es requerido</div>\r\n\t\t</div>\r\n\r\n\t\t<div class=\"form-group\" [ngClass]=\"{ 'has-error': f.submitted  && !type.valid}\">\r\n\t\t\t<label for=\"type\">Tipo</label> <select class=\"form-control\" [(ngModel)]=\"sportEvent.type\" name=type #type=\"ngModel\" >\r\n\t\t\t\t<option *ngFor=\"let c of eventtype\" [ngValue]=\"c.id\">{{c.name}}</option>\r\n\t\t\t</select>\r\n\t\t</div>\t\r\n\r\n\t\t<div class=\"form-group\" [ngClass]=\"{ 'has-error': f.submitted && !datestart.valid}\">\r\n\t\t\t<label for=\"datestart\">Fecha de Inicio [MM/DD/YYYY]</label> <input type=\"date\" class=\"form-control\"\r\n\t\t\t\tname=\"datestart\" required [ngModel]=\"sportEvent.datestart | date: 'yyyy-MM-dd'\" #datestart=\"ngModel\"\r\n\t\t\t\trequired (ngModelChange)=\"dateChanged1($event)\" />\r\n\t\t\t<div *ngIf=\"f.submitted && !datestart.valid\" class=\"help-block\">La fecha de Inicio es obligatorio</div>\r\n\t\t</div>\r\n\r\n\t\t<div class=\"form-group\" [ngClass]=\"{ 'has-error': f.submitted && !datefinish.valid}\">\r\n\t\t\t<label for=\"datefinish\">Fecha de Fin [MM/DD/YYYY]</label> <input type=\"date\" class=\"form-control\"\r\n\t\t\t\tname=\"datefinish\" required [ngModel]=\"sportEvent.datefinish | date: 'yyyy-MM-dd'\" #datefinish=\"ngModel\"\r\n\t\t\t\trequired (ngModelChange)=\"dateChanged2($event)\" />\r\n\t\t\t<div *ngIf=\"f.submitted && !datefinish.valid\" class=\"help-block\">La fecha de Fin es obligatorio</div>\r\n\t\t</div>\r\n\r\n\t\t<div class=\"form-group\">\r\n\t\t\t<button type=\"submit\" [disabled]=\"loading\" class=\"btn btn-primary\">Guardar</button>\r\n\t\t\t<img *ngIf=\"loading\"\r\n\t\t\t\tsrc=\"data:image/gif;base64,\" />\r\n\t\t\t<a [routerLink]=\"['/sport.list']\" class=\"btn btn-link\">Regresar</a>\r\n\t\t</div>\r\n\t</form>\r\n</div>"
...
var SportEventComponent = (function () {
    function SportEventComponent(route, router, sportEventService, alertService) {
        this.route = route;
        this.router = router;
        this.sportEventService = sportEventService;
        this.alertService = alertService;
        this.statuses = [{ id: 1, name: "Activo" }, { id: 0, name: "Inactivo" }];
        this.eventtype = [{ id: 1, name: "Rally" }, { id: 2, name: "XC" }, { id: 3, name: "XCO" }, { id: 4, name: "XCM" },
    ...
    // Main process
    SportEventComponent.prototype.register = function () {
        var _this = this;
        this.loading = true;
        // If Income is NaN, this will follow income creation
        if (isNaN(this.sportEvent.id)) {
            this.sportEventService.create(this.sportEvent)
                .subscribe(function (data) {
                _this.alertService.success('Registro exitoso', true);
                _this.router.navigate(['/sport.list']);
            }, function (error) {
                _this.alertService.error(error);
                _this.loading = false;
            });
    ...
    //Initializing screen values
    SportEventComponent.prototype.ngOnInit = function () {
        var _this = this;
        //Initializing income
        this.sportEvent = new __WEBPACK_IMPORTED_MODULE_4__models_index__["f" /* SportEvent */]();
        ...
        this.sub = this.route.params
            ...
            var id = +params['id'];
            if (!isNaN(id)) {
                _this.getSportEvent(id);
            }
        });
    };
    SportEventComponent.prototype.getSportEvent = function (id) {
        var _this = this;
        this.sportEventService.getById(id).subscribe(function (sportEvent) { return _this.sportEvent = sportEvent; }, function (error) { return _this.errorMessage = error; });
    };
    SportEventComponent.prototype.ngOnDestroy = function () {
        this.sub.unsubscribe();
    };
    SportEventComponent.prototype.dateChanged1 = function (newDate) {
        this.sportEvent.datestart = newDate;
    };
    SportEventComponent.prototype.dateChanged2 = function (newDate) {
    ...
    SportEventComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["n" /* Component */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_0__angular_common__["d" /* DatePipe */]]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* ActivatedRoute */],
            __WEBPACK_IMPORTED_MODULE_2__angular_router__["d" /* Router */],
            __WEBPACK_IMPORTED_MODULE_3__services_index__["j" /* SportEventService */],
...
module.exports = "<div class=\"container\">\r\n\t<h4>Eventos de ciclismo:</h4>\r\n\t<a *ngIf=\"isAdmin\" class=\"btn btn-default btn-sm\" [routerLink]=\"['/sport.event']\">Registrar nuevo evento</a><br>\r\n\t<br>\r\n\r\n\t<table>\r\n\t\t<tr>\r\n\t\t\t<td style=\"width: 10%\">Filtrar:</td>\r\n\t\t\t<td style=\"width: 20%\"><input class=\"form-control\" type=\"text\" width=\"50px\" maxlength=\"50\"></td>\r\n\t\t\t<td style=\"width: 10%\"></td>\r\n\t\t\t<td style=\"width: 10%\">Estado</td>\r\n\t\t\t<td style=\"width: 10%\"><select class=\"form-control\" [(ngModel)]=\"statusFilter\" name=statusFilter\r\n\t\t\t\t\t(change)=\"onChange3(this.periodFilter, $event.target.value)\">\r\n\t\t\t\t\t<option *ngFor=\"let c of statuses\" value=\"{{c.id}}\">{{c.name}}</option>\r\n\t\t\t\t</select> \r\n\t\t\t</td>\r\n\t\t\t<td style=\"width: 10%\"></td>\r\n\t\t\t<td style=\"width: 10%\">Periodo</td>\r\n\t\t\t<td style=\"width: 20%\">\r\n\t\t\t\t<select class=\"form-control\" [(ngModel)]=\"periodFilter\" name=periodFilter\r\n\t\t\t\t\t(change)=\"onChange3($event.target.value, this.statusFilter)\">\r\n\t\t\t\t\t<option *ngFor=\"let p of periods\" [ngValue]=\"p.id\">{{p.name}}</option>\r\n\t\t\t\t</select></td>\r\n\t\t</tr>\r\n\t</table>\r\n\t<br>\r\n\r\n\t<table class=\"table table-hover table-sm table-inverse table-responsive table-condensed\">\r\n\t\t<thead class=\"thead-inverse\">\r\n\t\t\t<tr>\r\n\t\t\t\t<th>#</th>\r\n\t\t\t\t<th>Nombre</th>\r\n\t\t\t\t<th>Tipo</th>\r\n\t\t\t\t<th>Organizador</th>\r\n\t\t\t\t<th>Lugar</th>\r\n\t\t\t\t<th>Fecha de inicio</th>\r\n\t\t\t\t<th>Fecha de fin</th>\r\n\t\t\t\t<th>Estado</th>\r\n\t\t\t\t<th></th>\r\n\t\t\t</tr>\r\n\t\t</thead>\r\n\t\t<tbody>\r\n\t\t\t<tr *ngFor=\"let event of events\">\r\n\t\t\t\t<td>{{event.id}}</td>\r\n\t\t\t\t<td>{{event.name}}</td>\r\n\t\t\t\t<td>{{showTypeDescription(event.type)}}</td>\r\n\t\t\t\t<td>{{event.organizer}}</td>\r\n\t\t\t\t<td>{{event.location}}</td>\r\n\r\n\t\t\t\t<td>{{event.datestart | date: 'yyyy-MM-dd'}}</td>\r\n\t\t\t\t<td>{{event.datefinish | date: 'yyyy-MM-dd'}}</td>\r\n\r\n\t\t\t\t<td>{{showStatusDescription(event.status)}}</td>\r\n\t\t\t\t<td *ngIf=\"isAdmin\"><a [routerLink]=\"['/sport.event', event.id]\">Modificar</a></td>\r\n\t\t\t</tr>\r\n\t\t</tbody>\r\n\t</table>\r\n</div>"
...
var SportListComponent = (function () {
    function SportListComponent(sportEventService, periodService) {
        this.sportEventService = sportEventService;
        this.periodService = periodService;
        this.statuses = [{ id: 1, name: "Activo" }, { id: 2, name: "Suspendido" }, { id: 0, name: "Inactivo" }, { id: -1, name: "Todos" }];
        this.eventtype = [{ id: 1, name: "Rally" }, { id: 2, name: "XC" }, { id: 3, name: "XCO" }, { id: 4, name: "XCM" },
    ...
    SportListComponent.prototype.ngOnInit = function () {
        // this.onChange(this.statusFilter);
        var _this = this;
        this.periodService.getByStatus(1).subscribe(function (periods) { _this.periods = periods; });
        this.onChange3(this.periodFilter, 1);
    };
    SportListComponent.prototype.deleteMember = function (id) {
        var _this = this;
        var retVal = confirm("Esta seguro de eliminar el evento seleccionado?");
        if (retVal == true) {
            this.sportEventService.delete(id).subscribe(function () { _this.loadAllUsers(1); });
            return true;
        }
        else {
            return false;
    ...
    SportListComponent.prototype.loadAllUsers = function (status) {
        var _this = this;
        this.sportEventService.getByStatus(status).subscribe(function (events) { _this.events = events; });
    };
    SportListComponent.prototype.showStatusDescription = function (status) {
        if (status == 1) {
            return "Activo";
        }
        else if (status == 2) {
    ...
    SportListComponent.prototype.showTypeDescription = function (type) {
        if (type == 1) {
            return "Rally";
        }
        else if (type == 2) {
    ...
    SportListComponent.prototype.onChange = function (status) {
        var _this = this;
        if (status != -1) {
            this.sportEventService.getByStatus(status).subscribe(function (events) { _this.events = events; });
        }
        else {
            this.sportEventService.getAll().subscribe(function (events) { _this.events = events; });
        }
    };
    SportListComponent.prototype.onChange2 = function (year) {
    };
    SportListComponent.prototype.onChange3 = function (year, status) {
        var _this = this;
        if (status != -1) {
            this.sportEventService.getByStatusAndPeriod(year.split(":")[1].trim(), status).subscribe(function (events) { _this.events = events; });
        }
        else {
            this.sportEventService.getAll().subscribe(function (events) { _this.events = events; });
        }
    ...
    SportListComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_index__["j" /* SportEventService */],
            __WEBPACK_IMPORTED_MODULE_1__services_index__["h" /* PeriodService */]])
    ], SportListComponent);
...
var environment = {
    production: true,
    // URL of development API    apiUrl: 'http://104.131.102.15:3000'
    // URL of development API     apiUrl: 'http://localhost:3000'
